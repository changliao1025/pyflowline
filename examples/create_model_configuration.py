...
from pyflowline.configuration.pyflowline_create_template_configuration_file import (
    pyflowline_create_template_configuration_file,
)
...
oPyflowline = pyflowline_create_template_configuration_file(
    sFilename_configuration_in,
    sWorkspace_input,
    sWorkspace_output,
    iFlag_use_mesh_dem_in=1,
