...
from pyflowline.configuration.pyflowline_read_configuration_file import (
...
sFilename_configuration_in = realpath(
    sPath_parent + "//data/susquehanna/input//pyflowline_susquehanna_latlon.json"
)
