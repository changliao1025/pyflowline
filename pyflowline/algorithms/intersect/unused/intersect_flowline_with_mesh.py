    ...
    for j in range(nfeature_mesh):
        ...
        if sGeometryname == 'POLYGON':
            ...
            for k in range(nPolygons):
                ...
                # Create unique ID for each polygon part
                part_id = f"{j}_part_{k}"
                index_mesh.insert(part_id, pBound)
    ...
    for j in range(nfeature_mesh):
        ...
        if sGeometryname == 'POLYGON':
            ...
            for k in range(nPolygons):
                ...
                # Create unique ID for each polygon part: original_index_part_k
                part_id = f"{j}_part_{k}"
                index_mesh.insert(part_id, pBound)
