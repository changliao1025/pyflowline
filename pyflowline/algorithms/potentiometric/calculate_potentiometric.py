def calculate_potentiometric(
    dElevation_bedrock_in, dThickness_ice_in, dDensity_ice_in=None
):
...
if __name__ == "__main__":
    ...
    dPotentiometric = calculate_potentiometric(
        dElevation_bedrock, dThickness_ice, dDensity_ice
    )
