...
def convert_dggrid_mesh_to_pyflowline_mesh(
    sFilename_dggrid_mesh, sFilename_mesh_pyflowline, iFlag_global_in=None
):
    ...
    for pFeature_mesh in pLayer_mesh:
        ...
        pdggrid = convert_gcs_coordinates_to_cell(
            5, dLongitude_center, dLatitude_center, aCoords_gcs
        )
    ...
    for pDggrid in aDggrid_middle:
        ...
        for lCellID1 in aNeighbor:
            ...
            dDistance = pDggrid.pVertex_center.calculate_distance(
                pDggrid1.pVertex_center
            )
...
def create_dggrid_mesh(
    ...
    if iFlag_mode == 1:  # call the binary directly
        ...
        aDggrid = convert_dggrid_mesh_to_pyflowline_mesh(
            sFilename_cell, sFilename_mesh, iFlag_global_in=iFlag_global
        )
