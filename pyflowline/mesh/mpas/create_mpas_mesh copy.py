...
def create_mpas_mesh(iFlag_global_in, 
    ...
    def add_cell_into_list(aList, i):
    ...
    if iFlag_antarctic == 1:
        ...
        for i in range(ncell):
            ...
            if ( iFlag == True ):
                ...
                aMpas = add_cell_into_list(aMpas, i)
    ...
    if iFlag_global_in == 1:
        ...
        for j in range(ncell):
            ...
            lNeighbor_hole = None         
            for lNeighbor in pCell.aNeighbor:
                if lNeighbor not in aCellID:
                    nNeighbor = nNeighbor - 1
                    lNeighbor_hole = lNeighbor
                    break               

            if nNeighbor == pCell.nVertex-1:    #this is a hole
                i = lNeighbor_hole-1
                dLat = convert_360_to_180 (aLatitudeCell[i])
                dLon = convert_360_to_180 (aLongitudeCell[i])
                #vertex
