...
class pybasin(object):
    ...
    def __init__(self, aParameter):
        ...
        self.sFilename_flowline_segment_index_before_intersect = 'flowline_segment_index_before_intersect' + sBasinID + '.shp'
        self.sFilename_flowline_segment_order_before_intersect = 'flowline_segment_order_before_intersect' + sBasinID + '.shp'
        self.sFilename_flowline_intersect  = 'flowline_intersect' + sBasinID + '.shp'
